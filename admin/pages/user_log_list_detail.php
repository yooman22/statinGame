...
if($search_key || $search_date){
  $user_log_list = $mpark->userLogListDetail($search_date,$search_key);
...
?>
    <tr>
      <td><?php echo $n; ?></td>
      <td><a href="./user_log_list.php?d=&q=<?php echo $v->user_uid;?>"><?php echo $v->user_uid;?></a></td>
      <td><?php echo $v->session_id;?></td>
      <td><a href="./user_log_list.php?d=&q=<?php echo $v->user_id;?>"><?php echo $v->user_id;?></a></td>
      <td><?php echo $v->user_name;?></td>
      <td><?php echo $v->user_knick;?></td>
      <td><a href="./user_log_list.php?d=<?php echo getDateFromTime($v->login_date);?>&q=<?php echo $v->user_uid;?>"><?php echo $v->login_date; ?></a></td>
      <td><a href="./user_log_list.php?d=<?php echo getDateFromTime($v->logout_date);?>&q=<?php echo $v->user_uid;?>"><?php echo $v->logout_date; ?></a></td>
